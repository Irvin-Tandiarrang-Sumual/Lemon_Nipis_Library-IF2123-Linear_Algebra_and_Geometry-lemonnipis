...
def build_lsa_model(dataset_dir: str, model_save_path: str, stop_words: set = DEFAULT_STOPWORDS,
    k: int = 50, use_stemming=False, overwrite: bool = False) -> Dict:
    # MODIFIED: Default argumen 'stop_words' diganti ke DEFAULT_STOPWORDS
...
def query_lsa(query_path: str, model: Dict, stop_words: set = DEFAULT_STOPWORDS, top_k: int = 5, use_stemming=False):
    # MODIFIED: Default argumen 'stop_words' diganti ke DEFAULT_STOPWORDS
    """
